...
- (void)viewDidLoad
{
    ...
    self.titleView = [[RZNavigationTitleView alloc] initWithFrame:CGRectMake(0., 0., 120., 44)];
    self.titleView.backgroundColor = [UIColor clearColor]; // should match navigationbar color
    self.navigationItem.titleView = self.titleView;
    
    KalView *kalView = [[KalView alloc] initWithFrame:self.view.frame dataSource:self.dataSource delegate:self logic:logic];
    self.view = kalView;
